...
class MainFragment : Fragment() {
    ...
    private val listener = Repository.OnLoadListener {
        RepositoryImpl.getCategoryFromServer()?.let { category ->
    ...
    private fun displayCategory(listOfCategory: List<Category>) {
    ...
    private fun displayCategoryData(category: Category) {
        ...
        adapter?.let {
            val categoryDiffResult = DiffUtil.calculateDiff(movieDiffUtilCallback)
